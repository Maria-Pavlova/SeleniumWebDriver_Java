...
public class EventReporter implements WebDriverListener {
    ...
    public void beforeGetWindowHandles(WebDriver driver) {
        ...
        System.out.println("Getting window handled");
    }
    ...
    public void beforeSubmit(WebElement element) {
        ...
        System.out.println("Submitting: " + element.getText());
    }
    ...
    public void beforeSendKeys(WebElement element, CharSequence... keysToSend) {
        ...
        System.out.println("Sending keys to: "+ element.toString() );
    }
    ...
    public void afterClear(WebElement element) {
        ...
        System.out.println(element.getText() + " was cleared!");
    }

    @Override
    public void beforeGetTagName(WebElement element) {
       // WebDriverListener.super.beforeGetTagName(element);
        System.out.println("Getting tagName of: "+ element.toString());
    }
    ...
    public void afterFindElement(WebElement element, By locator, WebElement result) {
        ...
        //System.out.println("Found element: "+ element.toString()+ " By: "+ locator.toString());
    }
    ...
    public void afterIsDisplayed(WebElement element, boolean result) {
       // WebDriverListener.super.afterIsDisplayed(element, result);
        System.out.println(element.toString() + " was displayed.");
    }
    ...
    public void afterGetSize(WebElement element, Dimension result) {
       // WebDriverListener.super.afterGetSize(element, result);
        System.out.println("The size of "+ element.toString() + " is: " + result);
    }
    ...
    public void afterAccept(Alert alert) {
     ...
     //   System.out.println("Accepted alert: " + alert);
    }

    @Override
    public void beforeDismiss(Alert alert) {
        WebDriverListener.super.beforeDismiss(alert);
     //   System.out.println("Dismissing alert: " + alert);
    }
